package si.skavtko.termini.api;
...
import si.skavtko.termini.zrna.TerminZrno;
...
public class TerminResource {
    ...
    public Response getResource(
        ...
        // TerminDTO data
            ...
            if(datumDoISO8601 == null || datumOdISO8601 == null || clanId == null) return Response.status(Status.BAD_REQUEST).build();
    ...
    public Response updateResources(
        ...
        public Response livenessTest(){
            if(terminZrno.checkDBconnection()){
